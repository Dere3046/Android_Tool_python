...
class TreeBuilder(_base.TreeBuilder):
    ...
    def __init__(self, *args, **kwargs):
        html_builder = etree_builders.getETreeModule(html, False, **('fullTree',))
        etree_builder = etree_builders.getETreeModule(etree, False, **('fullTree',))
    ...
    def insertComment(self, data, parent = (None,)):
        if not self.rootInserted:
            ...
            return None
        None.TreeBuilder.insertComment(self, data, parent)
