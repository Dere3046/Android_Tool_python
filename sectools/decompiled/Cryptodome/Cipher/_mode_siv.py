...
class SivMode(object):
    ...
    def __init__(self, factory, key, nonce, kwargs):
        ...
        if None is not None:
            ...
            self.nonce = None(None, None, nonce)
        subkey_size = len(key) // 2
        self._mac_tag = None
        self._kdf = _S2V(key[:subkey_size], factory, self._cipher_params, **('ciphermod', 'cipher_params'))
    ...
    def _create_ctr_cipher(self, v):
        ...
        q = v_int & 0xFFFFFFFFFFFFFFFF7FFFFFFF7FFFFFFFL
    # WARNING: Decompyle incomplete
