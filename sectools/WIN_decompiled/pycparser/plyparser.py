...
class PLYParser(object):
    ...
    def _coord(self, lineno, column = (None,)):
        return Coord(self.clex.filename, lineno, column, **('file', 'line', 'column'))
        ...
        if attr_name.startswith('p_'):
            ...
            if hasattr(method, '_params'):
                ...
                if method.__doc__ is not None:
                    ...
                    continue
                if not issued_nodoc_warning:
                    warnings.warn('parsing methods must have __doc__ for pycparser to work properly', RuntimeWarning, 2, **('stacklevel',))
...
def _create_param_rules(cls, func):
    ...
    for xxx, yyy in func._params:
        ...
        def param_rule(self = None, p = None):
            func(self, p)
