...
FOFX_DONTDISPLAYLOCATIONS = 0x80000000L
PO_DELETE = 19
PO_RENAME = 20
PO_PORTCHANGE = 32
PO_REN_PORT = 52
...
SHGVSPB_INHERIT = 16
SHGVSPB_ROAM = 32
SHGVSPB_NOAUTODEFAULTS = 0x80000000L
...
SLDF_RESERVED = 0x80000000L
EXP_SPECIAL_FOLDER_SIG = 0xA0000005L
NT_CONSOLE_PROPS_SIG = 0xA0000002L
NT_FE_CONSOLE_PROPS_SIG = 0xA0000004L
EXP_DARWIN_ID_SIG = 0xA0000006L
EXP_LOGO3_ID_SIG = 0xA0000007L
EXP_SZ_ICON_SIG = 0xA0000007L
EXP_SZ_LINK_SIG = 0xA0000001L
...
IS_VALIDSTATEBITS = IS_NORMAL | IS_SPLIT | IS_FULLSCREEN | 0x80000000L | 1073741824
AD_APPLY_SAVE = 1
AD_APPLY_HTMLGEN = 2
AD_APPLY_REFRESH = 4
AD_APPLY_ALL = AD_APPLY_SAVE | AD_APPLY_HTMLGEN | AD_APPLY_REFRESH
...
IExplorerCommand_Methods = [
    ...
    'GetFlags',
    'EnumSubCommands']
IExplorerCommandProvider_Methods = [
    'GetCommand',
    'GetCommands']
IOleWindow_Methods = [
    'GetWindow',
...
IPersist_Methods = [
    'GetClassID']
IPersistFolder_Methods = IPersist_Methods + [
    'Initialize']
IPersistFolder2_Methods = IPersistFolder_Methods + [
    'GetCurFolder']
...
COPYENGINE_E_USER_CANCELLED = 0x80270000L
COPYENGINE_E_CANCELLED = 0x80270001L
COPYENGINE_E_REQUIRES_ELEVATION = 0x80270002L
COPYENGINE_E_SAME_FILE = 0x80270003L
COPYENGINE_E_DIFF_DIR = 0x80270004L
COPYENGINE_E_MANY_SRC_1_DEST = 0x80270005L
COPYENGINE_E_DEST_SUBTREE = 0x80270009L
COPYENGINE_E_DEST_SAME_TREE = 0x8027000AL
COPYENGINE_E_FLD_IS_FILE_DEST = 0x8027000BL
COPYENGINE_E_FILE_IS_FLD_DEST = 0x8027000CL
COPYENGINE_E_FILE_TOO_LARGE = 0x8027000DL
COPYENGINE_E_REMOVABLE_FULL = 0x8027000EL
COPYENGINE_E_DEST_IS_RO_CD = 0x8027000FL
COPYENGINE_E_DEST_IS_RW_CD = 0x80270010L
COPYENGINE_E_DEST_IS_R_CD = 0x80270011L
COPYENGINE_E_DEST_IS_RO_DVD = 0x80270012L
COPYENGINE_E_DEST_IS_RW_DVD = 0x80270013L
COPYENGINE_E_DEST_IS_R_DVD = 0x80270014L
COPYENGINE_E_SRC_IS_RO_CD = 0x80270015L
COPYENGINE_E_SRC_IS_RW_CD = 0x80270016L
COPYENGINE_E_SRC_IS_R_CD = 0x80270017L
COPYENGINE_E_SRC_IS_RO_DVD = 0x80270018L
COPYENGINE_E_SRC_IS_RW_DVD = 0x80270019L
COPYENGINE_E_SRC_IS_R_DVD = 0x8027001AL
COPYENGINE_E_INVALID_FILES_SRC = 0x8027001BL
COPYENGINE_E_INVALID_FILES_DEST = 0x8027001CL
COPYENGINE_E_PATH_TOO_DEEP_SRC = 0x8027001DL
COPYENGINE_E_PATH_TOO_DEEP_DEST = 0x8027001EL
COPYENGINE_E_ROOT_DIR_SRC = 0x8027001FL
COPYENGINE_E_ROOT_DIR_DEST = 0x80270020L
COPYENGINE_E_ACCESS_DENIED_SRC = 0x80270021L
COPYENGINE_E_ACCESS_DENIED_DEST = 0x80270022L
COPYENGINE_E_PATH_NOT_FOUND_SRC = 0x80270023L
COPYENGINE_E_PATH_NOT_FOUND_DEST = 0x80270024L
COPYENGINE_E_NET_DISCONNECT_SRC = 0x80270025L
COPYENGINE_E_NET_DISCONNECT_DEST = 0x80270026L
COPYENGINE_E_SHARING_VIOLATION_SRC = 0x80270027L
COPYENGINE_E_SHARING_VIOLATION_DEST = 0x80270028L
COPYENGINE_E_ALREADY_EXISTS_NORMAL = 0x80270029L
COPYENGINE_E_ALREADY_EXISTS_READONLY = 0x8027002AL
COPYENGINE_E_ALREADY_EXISTS_SYSTEM = 0x8027002BL
COPYENGINE_E_ALREADY_EXISTS_FOLDER = 0x8027002CL
COPYENGINE_E_STREAM_LOSS = 0x8027002DL
COPYENGINE_E_EA_LOSS = 0x8027002EL
COPYENGINE_E_PROPERTY_LOSS = 0x8027002FL
COPYENGINE_E_PROPERTIES_LOSS = 0x80270030L
COPYENGINE_E_ENCRYPTION_LOSS = 0x80270031L
COPYENGINE_E_DISK_FULL = 0x80270032L
COPYENGINE_E_DISK_FULL_CLEAN = 0x80270033L
COPYENGINE_E_EA_NOT_SUPPORTED = 0x80270034L
COPYENGINE_E_CANT_REACH_SOURCE = 0x80270035L
COPYENGINE_E_RECYCLE_UNKNOWN_ERROR = 0x80270035L
COPYENGINE_E_RECYCLE_FORCE_NUKE = 0x80270036L
COPYENGINE_E_RECYCLE_SIZE_TOO_BIG = 0x80270037L
COPYENGINE_E_RECYCLE_PATH_TOO_LONG = 0x80270038L
COPYENGINE_E_RECYCLE_BIN_NOT_FOUND = 0x8027003AL
COPYENGINE_E_NEWFILE_NAME_TOO_LONG = 0x8027003BL
COPYENGINE_E_NEWFOLDER_NAME_TOO_LONG = 0x8027003CL
COPYENGINE_E_DIR_NOT_EMPTY = 0x8027003DL
COPYENGINE_E_FAT_MAX_IN_ROOT = 0x8027003EL
COPYENGINE_E_ACCESSDENIED_READONLY = 0x8027003FL
COPYENGINE_E_REDIRECTED_TO_WEBPAGE = 0x80270040L
COPYENGINE_E_SERVER_BAD_FILE_TYPE = 0x80270041L
...
KF_FLAG_NOT_PARENT_RELATIVE = 512
KF_FLAG_SIMPLE_IDLIST = 256
KF_FLAG_ALIAS_ONLY = 0x80000000L
