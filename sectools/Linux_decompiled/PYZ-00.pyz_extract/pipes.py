...
class Template:
    ...
    def prepend(self, cmd, kind):
        ...
        if None.steps and self.steps[0][1] == SOURCE:
    ...
    def open(self, file, rw):
        ...
        raise None("Template.open: rw must be 'r' or 'w', not %r" % (rw,))
