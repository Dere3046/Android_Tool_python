...
class TextCalendar(Calendar):
    ...
    def formatweek(self, theweek, width):
        ...
        '''
        return None((lambda .0 = None: for d, wd in .0:
self.formatday(d, wd, width))(theweek))
...
self.formatweekday(i, width))(self.iterweekdays()))
    ...
    def formatyear(self, theyear, w, l, c, m = (2, 1, 6, 3)):
        ...
        for i, row in enumerate(self.yeardays2calendar(theyear, m)):
            ...
            a('\n' * l)
            names = (lambda .0 = None: for k in .0:
self.formatmonthname(theyear, k, colwidth, False))(months)
            a(formatstring(names, colwidth, c).rstrip())
            a('\n' * l)
            headers = (lambda .0 = None: for k in .0:
header)(months)
            a(formatstring(headers, colwidth, c).rstrip())
            a('\n' * l)
            height = max((lambda .0: for cal in .0:
len(cal))(row))
...
class HTMLCalendar(Calendar):
    ...
    def formatweek(self, theweek):
        ...
        '''
        s = None((lambda .0 = None: for d, wd in .0:
self.formatday(d, wd))(theweek))
        return '<tr>%s</tr>' % s
    ...
    def formatweekheader(self):
        ...
        '''
        s = None((lambda .0 = None: for i in .0:
self.formatweekday(i))(self.iterweekdays()))
        return '<tr>%s</tr>' % s
    ...
    def formatyear(self, theyear, width = (3,)):
        ...
        for i in range(January, January + 12, width):
            ...
            for m in months:
                a('<td>')
                a(self.formatmonth(theyear, m, False, **('withyear',)))
                a('</td>')
            a('</tr>')
        a('</table>')
        return ''.join(v)
