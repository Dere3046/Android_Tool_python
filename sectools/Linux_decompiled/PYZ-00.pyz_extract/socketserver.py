...
class BaseServer:
    ...
    def handle_error(self, request, client_address):
        ...
        print('Exception occurred during processing of request from', client_address, sys.stderr, **('file',))
        import traceback
        traceback.print_exc()
        print('----------------------------------------', sys.stderr, **('file',))
...
if hasattr(os, 'fork'):
    ...
    class ForkingMixIn:
        ...
        def server_close(self = None):
            super().server_close()
            self.collect_children(self.block_on_close, **('blocking',))
...
class _Threads(list):
    ...
    def reap(self):
        self[:] = (lambda .0: for thread in .0:
if thread.is_alive():
threadcontinueNone)(self)
...
class ThreadingMixIn:
    ...
    def process_request(self, request, client_address):
        ...
        t = threading.Thread(self.process_request_thread, (request, client_address), **('target', 'args'))
