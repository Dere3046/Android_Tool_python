...
class RawConfigParser(MutableMapping):
    ...
    def __init__(self, defaults = None, dict_type = (None, _default_dict, False), allow_no_value = {
        ...
        if delimiters == ('=', ':'):
            ...
            d = '|'.join((lambda .0: for d in .0:
re.escape(d))(delimiters))
            if allow_no_value:
    ...
    def _read(self, fp, fpname):
        ...
        indent_level = 0
        e = None
        for lineno, line in enumerate(fp, 1, **('start',)):
            comment_start = sys.maxsize
            inline_prefixes = (lambda .0: pass# WARNING: Decompyle incomplete
            ...
            if mo:
                ...
                if sectname in self._sections:
                    ...
                    cursect = None._sections[sectname]
...
class SectionProxy(MutableMapping):
    ...
    def __init__(self, parser, name):
        ...
        for conv in parser.converters:
            key = 'get' + conv
            getter = functools.partial(self.get, getattr(parser, key), **('_impl',))
