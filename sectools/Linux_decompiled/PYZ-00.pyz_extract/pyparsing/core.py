...
import os
from typing import Optional as OptionalType, Iterable as IterableType, NamedTuple, Union, Callable, Any, Generator, Tuple, List, TextIO, Set, Dict as DictType, Sequence
...
class ParserElement(ABC):
    ...
    class DebugActions(NamedTuple):
        debug_fail: OptionalType[DebugExceptionAction] = 'ParserElement.DebugActions'
