...
class _PolicyBase:
    ...
    def clone(self, **kw):
        ...
        for attr, value in kw.items():
            ...
            None.__setattr__(newpolicy, attr, value)
        return newpolicy
...
def _extend_docstrings(cls):
    ...
    for name, attr in cls.__dict__.items():
        if attr.__doc__ and attr.__doc__.startswith('+'):
            for c in (lambda .0: for base in .0:
for c in base.mro():
c)(cls.__bases__):
