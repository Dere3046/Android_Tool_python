    ...
    def _read_pypirc(self):
        ...
        if os.path.exists(rc):
            ...
            if 'distutils' in sections:
                ...
                _servers = (lambda .0: [ server.strip() for server in .0 if server.strip() != '' ])(index_servers.split('\n'))
                if _servers == []:
                    if 'pypi' in sections:
                        _servers = [
                            'pypi']
                    ...
                    for server in None:
                        ...
                        if server == 'pypi' and repository in (self.DEFAULT_REPOSITORY, 'pypi'):
                            ...
                            return current
                        if None['server'] == repository or current['repository'] == repository:
                            return current
                        return { }
                        if 'server-login' in sections:
                            server = 'server-login'
