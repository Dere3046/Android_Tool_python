"""ELF 64-bit header implementation."""

from common.data.binary_struct import StructBase
from common.parser.elf.defines import ELFCLASS64, EV_CURRENT


class ELFHeader64(StructBase):
    """ELF 64-bit header."""

    STRUCT_FORMAT = '<16sHHIQQQIHHHHHH'
    STRUCT_FIELDS = (
    ...
    def e_ident_class(self):
        return self.e_ident[4] if len(self.e_ident) >= 5 else ELFCLASS64
