"""ELF 32-bit section header implementation."""
...
class SectionHeader32(AbstractPositionalData, StructBase):
    ...
    STRUCT_FORMAT = '<IIIIIIIIII'  # 10 32-bit integers
    STRUCT_FIELDS = (
        ...
        'sh_ent_size',  # Section entry size (if section contains fixed-size entries)
    )
    ...
    def validate_before_operation(self, **kwargs):
        ...
        if self.sh_type == SHT_NOBITS and self.sh_offset != 0:
            pass  # SHT_NOBITS section offset should be 0
