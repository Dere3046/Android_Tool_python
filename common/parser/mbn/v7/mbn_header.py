...
@dataclass
class MBNHeaderV7(StructDynamic):
    """MBN version 7 header - 40 bytes header + 24 bytes padding = 64 bytes total."""
    ...
    @classmethod
    def unpack(cls, data: bytes) -> 'MBNHeaderV7':
        """Unpack from bytes."""
        return cls(data)
