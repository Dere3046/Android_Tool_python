...
@dataclass
class MBNHeaderV3(StructDynamic):
    """MBN version 3 header - 40 bytes format."""
    ...
    def __init__(self, data: Optional[bytes] = None, **kwargs):
        """Initialize MBN v3 header."""
        self.boot_image_id = 0
        self.version = 3
        self.image_src = 0
    ...
    @classmethod
    def unpack(cls, data: bytes) -> 'MBNHeaderV3':
        """Unpack from bytes."""
        return cls(data)
